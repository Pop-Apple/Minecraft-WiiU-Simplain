...
namespace TCPGeckoSharp
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (TCPGeckoSharp.ValidMemory.rangeCheckId(startdump) != TCPGeckoSharp.ValidMemory.rangeCheckId(enddump))
            {
                enddump = TCPGeckoSharp.ValidMemory.ValidAreas[TCPGeckoSharp.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!TCPGeckoSharp.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!TCPGeckoSharp.ValidMemory.validAddress(address))
            {
                return 0;
            }
