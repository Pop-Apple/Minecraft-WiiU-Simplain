...
namespace Universal_Minecraft_Editor_Mod__
{
	public partial class Main : Form
	{
        ...
        private void btnEdit_Click(object sender, EventArgs e)
		{
			...
			{
				//Area_Effect_Cloud
				MessageBox.Show("Entityファイルにペーストします" + Environment.NewLine + "" + Environment.NewLine + "UUIDを変えてください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 1)
			{
				//Attribute
				MessageBox.Show("アイテムタグにペーストします" + Environment.NewLine + "" + Environment.NewLine + "AmountIDを指定してください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 2)
			{
				//Entity Pos
				MessageBox.Show("すべてのファイルに適応可能です" + Environment.NewLine + "" + Environment.NewLine + "ポジション(座標)を指定してください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 3)
			{
				//Entity Health
				MessageBox.Show("MOB Entity にペーストします" + Environment.NewLine + "" + Environment.NewLine + "Healthの数値を指定してください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 4)
			{
				//Spawen Villager
				MessageBox.Show("インベントリタグにペーストします" + Environment.NewLine + "" + Environment.NewLine + "村人の設定を行なってください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 5)
			{
				//Unknown
				MessageBox.Show("インベントリタグにペーストします" + Environment.NewLine + "" + Environment.NewLine + "アイテムIDを選択して値を入力してください", "ヘルプ", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
			if (checkBox2.Checked && comboBox1.SelectedIndex == 6)
			{
				//Unknown
				MessageBox.Show("Unknown","None", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
			}
		}
